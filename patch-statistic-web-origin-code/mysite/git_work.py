...
def update_database0(para1,para2,inc):
    ...
    name_list1 = ['Li Zhong','Wei Yang','Jia He','Boqun Feng','Boqun Feng','Xiao Guangrong','Mike Qiu','Guo Chao','Zhi Yong Wu','Cong Meng','Li Zhang','Li Zhang']
    mail_list1 = ['zhong@linux.vnet.ibm.com','weiyang@linux.vnet.ibm.com','hejianet@gmail.com','boqun.feng@gmail.com','boqun.feng@linux.vnet.ibm.com','xiaoguangrong@linux.vnet.ibm.com','qiudayu@linux.vnet.ibm.com','yan@linux.vnet.ibm.com','wuzhy@linux.vnet.ibm.com','mc@linux.vnet.ibm.com','zhlcindy@gmail.com','zhlcindy@linux.vnet.ibm.com']
    mysql_init(tablename1)
    run(tablename1,project_dir1, date_from, date_to, search_key,mail_list1,name_list1)
    
    name_list2 = ['hejianet']
    mail_list2 = ['hejianet@linux.vnet.ibm.com']
    ...
    name_list3 = ['parklong','park hei','park hei','Wen Zhi Yu']
    mail_list3 = ['heijlong@linux.vnet.ibm.com','heijlong@linux.vnet.ibm.com','jianlonghei@gmail.com','wenzhi_yu@163.com']
